...
urlpatterns = [
    ...
    path('rename-column/', views.rename_article_column,
    ...
    path('article-content/<int:id>/<slug:slug>/',
         list_views.article_detail, name='article_content')
    # re_path('article-content/(?P<id>\d+)/(?P<slug>[-\w]+)/$',
    #        list_views.article_detail, name="article_content"),
]
